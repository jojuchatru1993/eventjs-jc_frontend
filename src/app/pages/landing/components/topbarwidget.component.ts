...
@Component({
    ...
    template: `<a class="flex items-center" href="landing">
            ...
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">EventsJC</span>
        </a>
        ...
        <div class="items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-20 rounded-border">
            <ul class="list-none p-0 m-0 flex lg:items-center select-none flex-col lg:flex-row cursor-pointer gap-8">
                <li>
                    <a (click)="scrollToSection('home')" pRipple class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Inicio</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a (click)="scrollToSection('events')" pRipple class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Eventos</span>
                    </a>
                </li>
            </ul>
            <div class="flex border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
                ...
                <ng-template #authenticatedTemplate>
                    <button pButton pRipple label="Cerrar sesión" (click)="logout()" [rounded]="true"></button>
                </ng-template>
            </div>
        </div> `
})
